...
void EPatch::setUpBezierSurface(SmoothingViewer::ConstructionMode mode) {
	...
	build4sidedPatch(mode);
}

void EPatch::generateBezierSurface(size_t resolution, std::vector<MyViewer::MyTraits::Point>& vertices) {
